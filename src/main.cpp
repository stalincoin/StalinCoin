...
const string strMessageMagic = "StalinCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 450000000 * COIN; return nSubsidy; 
	}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "StalinCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Joseph Vissarionovich Stalin - 18 December 1878 – 5 March 1953";
        CTransaction txNew;
        txNew.nTime = 1489048102;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1489048102;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 4337195;
		if(fTestNet)
        {
            block.nNonce = 4337195;
        }
		
		uint256 nhashMerkleRoot = uint256("1be751d44d9cea0e9a01b4c51e46d079d0a91232df0e243bdf6780439dd76b0c");
